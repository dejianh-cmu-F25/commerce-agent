...
regenerated by the gate; rendered-prompt hash `8578920a4f16`): Pass@1 **0.833**
(95% CI [0.611, 1.000]) · Pass@k 0.833 · Pass^k **0.833**; 0 ungrounded attempts;
0 judge vetoes; avg 1.67 steps; p95 4597 ms; **¥0.0797**.

- Source: `evals/report.md`; aggregate: [`specs/RESULTS.md`](../RESULTS.md).

## Real-World Coverage

- **Input distribution**: seeded templates including negative cases; adversarial
  input is covered by the guard set (`evals/adversarial.py`); non-English phrasing
  remains thin.
...
- **Scale envelope**: 6 templates × 3 seeds; the system envelope is measured in `docs/scale.md`.
