"""Reusable keyless scenario runner (features 011, 016).

The gate CLI (``evals/run.py``) and the web Scenario Runner both call
``run_scenarios`` so their results cannot drift. Only the model is scripted
