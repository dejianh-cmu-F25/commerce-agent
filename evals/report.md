...
Generated by `uv run python evals/report.py --write` on 2026-09-14.
...
| `dense-chroma` | 1.000 | 1.000 | 0.873 | 0.4 |
...
| `cost:spent_cny` | 1.1927 | +0.5365 | 10.0 | ≤ | `budget` | OK |
...
| ---: | ---: | ---: | ---: | ---: |
| 1 | 12.9/18.0 | 15.0/20.2 | 50491 | 0 |
| 4 | 11.2/15.9 | 14.7/15.2 | 57712 | 0 |
| 16 | 11.4/15.8 | 14.7/18.4 | 56110 | 0 |
| 64 | 11.7/16.5 | 14.8/15.5 | 56834 | 0 |

Large corpus (10000 chunks, concurrency 16): retrieval p50/p95 **4030.8/6074.3 µs** (budget 50000 µs).

Large catalog (5000 products, concurrency 16): search p50/p95 **12238.8/12692.0 µs** (budget 50000 µs).
